...
class User(UserBase):
    ...
    usage_count: int = Field(0, description="Number of PDFs generated by the user")
    usage_limit: int = Field(10, description="Maximum number of PDFs the user can generate")
